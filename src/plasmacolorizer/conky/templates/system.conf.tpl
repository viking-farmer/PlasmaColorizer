...
-- Uses ``desktop`` window type (safer under Plasma Wayland / XWayland). The
-- Conky tab can switch back to ``normal``+``below`` if you prefer cleaner
-- overlap repaints and accept a higher risk of shell instability.
